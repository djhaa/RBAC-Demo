...
-- ----------------------------
BEGIN;
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (3, 'admin', '$2a$10$f9onkPUki71jZIHHith57umpwu45eGAxGGqanImELv2pgYyZlwUXm', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2021-12-29 16:12:41', 1);
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (6, 'productAdmin', '$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1);
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (7, 'orderAdmin', '$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', NULL, 1);
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (10, 'ceshi', '$2a$10$RaaNo9CC0RSms8mc/gJpCuOWndDT4pHH0u5XgZdAAYFs1Uq4sOPRi', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'ceshi@qq.com', 'ceshi', NULL, '2020-03-13 16:23:30', NULL, 1);
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (16, 'root', '$2a$10$p339H8.VHY2ambKK9y.oCesY8/Y9UoHSmXeJocSnD.PFJ1kjqVrAG', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'djhaa@gmail.com', 'djhaa', 'djhaa', '2021-12-21 20:12:10', '2021-12-28 16:52:49', 1);
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (17, 'test', '$2a$10$3ipwSR2rkcruy7btId5mS.d8x8.EZr6S6MpV6LHFYDbXxMaJW5nhW', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'test@gmail.com', 'test', '测试账号(仅拥有查看权限)', '2021-12-29 14:18:17', '2021-12-29 18:28:40', 1);
COMMIT;
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=322 DEFAULT CHARSET=utf8mb3 COMMENT='后台用户登录日志表';
...
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (287, 16, '2021-12-21 20:24:10', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (288, 10, '2021-12-21 20:24:55', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (289, 4, '2021-12-21 20:25:56', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (290, 4, '2021-12-21 20:26:22', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (291, 4, '2021-12-21 20:30:09', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (292, 3, '2021-12-21 20:31:00', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (293, 4, '2021-12-21 20:31:24', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (294, 4, '2021-12-21 20:34:54', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (295, 4, '2021-12-23 17:07:29', '172.17.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (296, 4, '2021-12-23 18:11:00', '172.17.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (297, 4, '2021-12-24 14:36:13', '172.17.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (298, 3, '2021-12-28 16:01:23', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (299, 3, '2021-12-28 16:21:53', '172.17.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (300, 3, '2021-12-28 16:43:45', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (301, 16, '2021-12-28 16:52:49', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (302, 3, '2021-12-28 17:05:44', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (303, 3, '2021-12-29 14:13:02', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (304, 17, '2021-12-29 14:19:43', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (305, 17, '2021-12-29 14:37:05', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (306, 17, '2021-12-29 14:39:34', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (307, 17, '2021-12-29 14:41:58', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (308, 17, '2021-12-29 14:44:14', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (309, 17, '2021-12-29 14:58:49', '172.17.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (310, 3, '2021-12-29 15:00:44', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (311, 3, '2021-12-29 15:07:20', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (312, 3, '2021-12-29 15:37:18', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (313, 17, '2021-12-29 15:43:27', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (314, 3, '2021-12-29 15:53:25', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (315, 17, '2021-12-29 16:02:59', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (316, 3, '2021-12-29 16:08:17', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (317, 3, '2021-12-29 16:11:35', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (318, 3, '2021-12-29 16:12:41', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (319, 17, '2021-12-29 17:27:45', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (320, 17, '2021-12-29 17:29:37', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (321, 17, '2021-12-29 18:28:40', '0:0:0:0:0:0:0:1', NULL, NULL);
COMMIT;
...
INSERT INTO `ums_admin_role_relation` (`id`, `admin_id`, `role_id`) VALUES (41, 16, 1);
INSERT INTO `ums_admin_role_relation` (`id`, `admin_id`, `role_id`) VALUES (42, 1, 8);
INSERT INTO `ums_admin_role_relation` (`id`, `admin_id`, `role_id`) VALUES (43, 17, 9);
COMMIT;
...
INSERT INTO `ums_resource_category` (`id`, `create_time`, `name`, `sort`) VALUES (2, '2020-02-05 10:22:34', '订单模块', 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `ums_role` (`id`, `name`, `description`, `admin_count`, `create_time`, `status`, `sort`) VALUES (1, 'admin_product', '只能查看及操作商品', 0, '2020-02-03 16:50:37', 1, 0);
INSERT INTO `ums_role` (`id`, `name`, `description`, `admin_count`, `create_time`, `status`, `sort`) VALUES (2, 'admin_order', '只能查看及操作订单', 0, '2018-09-30 15:53:45', 1, 0);
INSERT INTO `ums_role` (`id`, `name`, `description`, `admin_count`, `create_time`, `status`, `sort`) VALUES (5, 'admin_super', '拥有所有查看和操作功能', 0, '2020-02-02 15:11:05', 1, 0);
INSERT INTO `ums_role` (`id`, `name`, `description`, `admin_count`, `create_time`, `status`, `sort`) VALUES (8, 'admin_permission', '用于权限模块所有操作功能', 0, '2020-08-24 10:57:35', 1, 0);
INSERT INTO `ums_role` (`id`, `name`, `description`, `admin_count`, `create_time`, `status`, `sort`) VALUES (9, 'admin_test', '仅拥有查看各菜单内容权限', 0, '2021-12-28 17:10:22', 1, 0);
COMMIT;
...
CREATE TABLE `ums_role_menu_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色菜单关系表';
...
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (135, 9, 1);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (136, 9, 2);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (137, 9, 3);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (138, 9, 4);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (139, 9, 5);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (140, 9, 6);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (141, 9, 7);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (142, 9, 8);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (143, 9, 9);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (144, 9, 10);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (145, 9, 11);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (146, 9, 12);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (147, 9, 13);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (148, 9, 14);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (149, 9, 16);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (150, 9, 17);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (151, 9, 18);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (152, 9, 19);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (153, 9, 20);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (154, 9, 21);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (155, 9, 22);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (156, 9, 23);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (157, 9, 24);
INSERT INTO `ums_role_menu_relation` (`id`, `role_id`, `menu_id`) VALUES (158, 9, 25);
COMMIT;
...
CREATE TABLE `ums_role_resource_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=221 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色资源关系表';
